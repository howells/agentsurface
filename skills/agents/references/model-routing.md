...
This pattern lets you switch between free tiers (Google AI), cost-effective routing
(OpenRouter), direct API access (Anthropic, OpenAI), and local subscriptions (Envelope)
