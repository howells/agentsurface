...
Freshness note: last reviewed 2026-06-02. Embedding model names, pricing, dimensions, and leaderboard positions change quickly; verify current provider docs and run your own eval set before making a vendor decision.
