...
Freshness note: last reviewed 2026-06-02. Provider-specific model, pricing, benchmark, and cost-ratio claims age quickly; use the anti-patterns as design checks and validate figures against current docs before procurement or architecture decisions.
...
**Fix:** Use contextual retrieval where chunks lose meaning outside the parent document. Anthropic reported a 49–67% reduction in top-20 retrieval failure on its benchmark; validate against your corpus.
