...
Tag the rubric release: `agentify-rubric-v1.2` (date: 2026-09-01).
...
Solution: Limit to 10 dimensions. If you want to add one, consider whether it overlaps with existing ones or if it's truly foundational.
...
□ Tag rubric version: agentify-rubric-vX.Y (date)
