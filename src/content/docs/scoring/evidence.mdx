...
2. **Run a specific command** to reveal the truth
   - Example: `grep -c "operationId:" openapi.yaml`
...
**Update scores iteratively.** As you discover new evidence, update both the score and confidence level.
