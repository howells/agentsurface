...
Default: claude-opus-5 (best for complex analysis and coding)
...
See https://code.claude.com/docs/en/agent-sdk/overview for permission mode details.
...
Default: claude-opus-5 (complex analysis)
