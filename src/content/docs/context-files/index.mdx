...
Context files go stale. Commands change, directories move, conventions evolve. Use `agentify score --dimension=context` or custom CI checks to detect drift. Automated audits ensure files stay current.
