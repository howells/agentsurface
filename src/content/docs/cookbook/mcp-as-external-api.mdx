...
- **MCP 0.6+ compatible**: Standard protocol; any client can implement.
...
// GET /.well-known/mcp — MCP discovery (OAuth/info endpoint)
...
1. **Claude Desktop**: List in the Anthropic plugin marketplace (coming soon).
2. **ChatGPT**: List as a Custom Action in the GPT Store.
3. **Cursor**: Contact Cursor team for integration.
4. **Website**: Add "Use with Claude" / "Use with ChatGPT" buttons on your docs.
