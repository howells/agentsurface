...
**Stack**: MCP 0.6+, Zod for schema validation.
...
**Stack**: MCP 0.6+, OAuth 2.1, DPoP (Demonstration of Proof-of-Possession).
...
**Stack**: Bun + Turborepo monorepo, Next.js, React, TypeScript, Vercel AI SDK 0.6+, MCP 0.6+, Composio, multi-platform bot adapters (WhatsApp, Telegram, Slack, iMessage via Sendblue).
