...
// Cost: ~10KB of token tokens just listing tools.
...
Use tiered caching: an LRU cache for per-user tool sessions, and a short-lived cache for the external app catalog:
