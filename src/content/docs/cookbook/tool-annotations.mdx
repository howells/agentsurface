...
When truncated, the response includes `meta.truncated: true` — the model sees this and can tell the user "Showing first N results. Use filters or pagination for more."

Combine with Zod schema sanitization to strip internal fields before they reach the model:
