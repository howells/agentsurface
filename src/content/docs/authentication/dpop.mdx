...
MCP has encouraged DPoP for remote servers that expose sensitive operations since the `2025-11-25` revision, and the newer `2026-07-28` revision does not change that. An MCP server can require DPoP proofs on every resource access:
