...
| Pattern                                | Fix                                                         |
| -------------------------------------- | ----------------------------------------------------------- |
| Wrong grant for the acting identity | Authorization Code + PKCE for user delegation; Client Credentials for service-owned M2M |
...
| -------------------------------------- | --------------------------------- | -------------------------------------------------- |
| Wrong grant for the acting identity | User consent or service access cannot complete | Match the grant to the principal and client |
