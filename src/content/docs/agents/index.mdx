...
- [OpenAI Platform](/docs/agents/openai-platform) — current Responses API, Agents SDK, hosted Shell tool, Agent Skills in the API, compaction, tools, model, and security guidance
