...
## Product-area indexes and pricing

For a large site, link section-level llms.txt files from the root index and verify both levels. Keep authoritative prices in sync across visible pages and a pricing.md representation when useful. See [Commercial and Entity Discovery](/docs/discovery/commercial-and-entity-discovery) for scope, provenance, and validation.
