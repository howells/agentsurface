...
Every command, including leaf commands, must support `--help --json` returning structured schema output. This is the foundation of agent schema introspection (see [Schema Introspection](./schema-introspection)).
