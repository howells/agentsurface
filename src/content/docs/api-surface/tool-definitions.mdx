...
<Callout type="info">
  When you need to expose a large API surface, use dynamic tool selection rather than loading all
  tools at once. See the [Dynamic Tool Selection](#dynamic-tool-selection) section below.
</Callout>
