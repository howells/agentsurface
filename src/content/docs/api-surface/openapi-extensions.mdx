...
<Callout type="info">
  Start by identifying the top 5 user-facing tasks your API needs to support. Build tools for those
  tasks, not for every endpoint. Expand the tool set incrementally as you validate that existing
