...
<Callout type="info">
  ...
  as with Streamable HTTP or SSE transport. Stdio servers that terminate after each interaction
  cannot maintain subscription state. See [Transport Selection](./transports) for details.
</Callout>
