...
A judge model tends to prefer outputs from itself or similar models. If you use GPT-5.6 to judge outputs from Claude Opus 5, the judge may systematically overrate outputs that look like GPT-style reasoning.
