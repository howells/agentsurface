...
Yes → Check the commerce platform and target host first. Use a supported hosted checkout handoff or a compatible UCP/ACP integration; MCP tool access alone does not establish payment or order support. See [Agentic Commerce](/docs/protocols/agentic-commerce).
